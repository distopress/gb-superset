const SvgReloadWindow = (props) => (
	...
	>
		...
		<path
			...
			d="M2 7h20M5 5.01l.01-.011M8 5.01l.01-.011M11 5.01l.01-.011M21.667 16.667C21.047 15.097 19.635 14 17.99 14c-1.758 0-3.252 1.255-3.793 3"
		/>
		<path
			stroke="currentColor"
			strokeLinecap="round"
