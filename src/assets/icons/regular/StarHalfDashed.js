const SvgStarHalfDashed = (props) => (
	...
	>
		...
		<path
			...
			strokeLinecap="round"
			strokeLinejoin="round"
			d="m15.413 8.236-2.598-5.232A.9.9 0 0 0 12 2.5v16.178l5.195 2.716c.666.349 1.446-.214 1.319-.953l-.992-5.75 4.202-4.07a.902.902 0 0 0-.503-1.54z"
		/>
	</svg>
);
