const SvgDatabaseBackup = (props) => (
	...
	>
		<path
			...
			d="M4 6v6s0 3 7 3q.888 0 1.631-.06M18 6v6"
		/>
		<path
			stroke="currentColor"
			strokeLinecap="round"
			strokeLinejoin="round"
			d="M11 3c7 0 7 3 7 3s0 3-7 3-7-3-7-3 0-3 7-3M11 21c-7 0-7-3-7-3v-6M22.666 17.667C22.048 16.097 20.634 15 18.99 15c-1.758 0-3.252 1.255-3.793 3"
		/>
		<path
			stroke="currentColor"
			strokeLinecap="round"
