const SvgCloudDesync = (props) => (
	...
	>
		...
		<path
			...
			strokeLinecap="round"
			strokeLinejoin="round"
			d="m16.067 21.962.353-2.475-2.475.354zM7.58 16.902l1.768-1.768a4 4 0 0 1 5.657 0l.354.353"
		/>
		<path
			stroke="currentColor"
			strokeLinecap="round"
			strokeLinejoin="round"
			d="m7.934 14.427-.353 2.475 2.474-.354z"
		/>
	</svg>
);
