const SvgVehicleGreen = (props) => (
	...
	>
		...
		<path
			stroke="currentColor"
			strokeLinecap="round"
			d="M6 18H2v2.4a.6.6 0 0 0 .6.6h2.8a.6.6 0 0 0 .6-.6zm0 0h7M2 18v-6.59a2 2 0 0 1 .162-.787l2.319-5.41A2 2 0 0 1 6.319 4h9.362a2 2 0 0 1 1.839 1.212l2.318 5.41a2 2 0 0 1 .162.789V12.5"
		/>
		<path
			stroke="currentColor"
			strokeLinecap="round"
