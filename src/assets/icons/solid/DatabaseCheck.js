const SvgDatabaseCheck = (props) => (
	...
	>
		<path
			fill="currentColor"
			fillRule="evenodd"
			d="M13.47 18.47a.75.75 0 0 1 1.06 0L17 20.94l4.47-4.47a.75.75 0 1 1 1.06 1.06l-5 5a.75.75 0 0 1-1.06 0l-3-3a.75.75 0 0 1 0-1.06"
			clipRule="evenodd"
		/>
		<path
			fill="currentColor"
			fillRule="evenodd"
			d="M15.591 17.409a2.25 2.25 0 1 0-3.182 3.182l1.021 1.02c-.713.09-1.519.139-2.43.139-3.59 0-5.547-.767-6.613-1.68-.536-.46-.825-.939-.977-1.33a2.5 2.5 0 0 1-.156-.648l-.003-.055v-.02l-.001-.01v-.005S3.25 18 4 18h-.75v-2.25A.75.75 0 0 1 4 15c.414-.001.954.266 1.237.568a1 1 0 0 0 .074.072c.69.493 2.256 1.11 5.689 1.11s4.999-.617 5.69-1.11q.045-.033.087-.067c.36-.288.761-.574 1.223-.573a.75.75 0 0 1 .75.75v1.318L17 18.818z"
			clipRule="evenodd"
		/>
		<path
			fill="currentColor"
