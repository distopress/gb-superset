const SvgHealthcare = (props) => (
	...
	>
		...
		<path
			...
			strokeLinecap="round"
			strokeLinejoin="round"
			d="m6 16-.858-.858A.49.49 0 0 1 5 14.799v0c0-.183.104-.35.268-.433l.443-.221a2 2 0 0 1 2.308.374l.895.895a2 2 0 0 1 .586 1.414V20M13.667 12h-3.334V9.667H8V6.333h2.333V4h3.334v2.333H16v3.334h-2.333z"
		/>
	</svg>
);
