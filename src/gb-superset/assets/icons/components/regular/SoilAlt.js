const SvgSoilAlt = (props) => (
	...
	>
		...
		<path
			...
			strokeLinecap="round"
			strokeLinejoin="round"
			d="m16.186 2.241.374 3.89c.243 2.523-1.649 4.77-4.172 5.012-2.475.238-4.718-1.571-4.956-4.047a4.503 4.503 0 0 1 4.05-4.914l4.147-.4a.51.51 0 0 1 .557.46"
		/>
	</svg>
);
