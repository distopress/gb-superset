const SvgSpockHandGesture = (props) => (
	<svg
	...
	>
		<path
			...
			d="m18 7.5.919.153a2 2 0 0 1 1.623 2.407l-.528 2.376a.6.6 0 0 0-.014.13V17.5q0 0 0 0c0 2-1.6 4-4 4H9.42a2 2 0 0 1-1.519-.698l-4.548-5.307a1.58 1.58 0 0 1-.034-2.018v0a1.582 1.582 0 0 1 2.426-.054L8 16v-3.5"
		/>
		<path
			stroke="currentColor"
			strokeLinecap="round"
